# there was a little formatting bug in scvelo's velocity_embedding_stream that meant the size of arrowheads could not be adjusted.
...
def velocity_embedding_stream(
    ...
    **kwargs,
    ...
    if multikey is not None:
        ...
        ax.streamplot(X_grid[0], X_grid[1], V_grid[0], V_grid[1], **stream_kwargs, arrowsize=arrowsize)
